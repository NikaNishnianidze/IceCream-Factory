...
export default function Locations() {
  return (
    <div className="flex flex-col items-center">
      <div className="mt-[150px] flex flex-col w-[358px]">
        <div className="titles flex flex-col gap-[20px]">
          <h2 className="text-[#04AED2] text-[27px] font-black w-[186px]">
            გაყიდვების <span className="text-[#001519]">წერტილები</span>
          </h2>
          <p className="locationtext text-[16px] font-normal">
            გემრიელი სიახლეები შენს ახლოს! იპოვე ჩვენი გაყიდვის წერტილები რუკაზე
            ან მისამართების სიაში და დატკბი შენი საყვარელი ნაყინით ნებისმიერ
            დროს.
          </p>
        </div>
